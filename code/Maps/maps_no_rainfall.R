...
# Save DF -------------------------------------------------------------
Path <- paste0("~/INVASIBILITY_THRESHOLD/output/ERA5/temp/2020/R0_clim_NO_H",
               year,".Rds")
...
Path <- paste0("~/INVASIBILITY_THRESHOLD/output/R0/datasets/R0_NO_H",year,".Rds")
saveRDS(df_group_y,Path)
...
Path <- paste0("~/Documentos/PHD/2023/INVASIBILITY/Plots/MS/Maps/",year,"/NO_h_New_AlboSum",year,".pdf")
dev.copy2pdf(file=Path, width = 7, height = 5)

df_group_y$R0 <- df_group_y$R0_sum_aeg
plot_sum_aeg <- plot_summonths(df_group_y)
plot_sum_aeg
Path <- paste0("~/Documentos/PHD/2023/INVASIBILITY/Plots/MS/Maps/",year,"/NO_h_New_Sum",year,".pdf")
dev.copy2pdf(file=Path, width = 7, height = 5)

df_group_y$R0 <- df_group_y$R0_sum_jap
plot_sum_jap <- plot_summonths(df_group_y)
plot_sum_jap
Path <- paste0("~/Documentos/PHD/2023/INVASIBILITY/Plots/MS/Maps/",year,"/NO_h_New_JapSum",year,".pdf")
dev.copy2pdf(file=Path, width = 7, height = 5)
